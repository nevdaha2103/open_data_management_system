...
| ОСНОВНИЙ СЦЕНАРІЙ	| 1. Адміністратор входить у систему.<br/> 2.Адміністратор відкриває вкладку з управлінням даними.<br/> 3.Натискає «Додати нові дані».<br/> Система відкриває форму для введення нових даних (наприклад, назва, опис, тип даних).<br/> 4. Адміністратор заповнює всі необхідні поля.<br/> 5.Адміністратор натискає «Зберегти».<br/> 7.Система перевіряє правильність даних і зберігає їх у базі. |
