...
| ОСНОВНИЙ СЦЕНАРІЙ	| Адміністратор входить у систему.<br/> Адміністратор відкриває вкладку з управлінням даними.<br/>
Натискає «Додати нові дані».<br/> Система відкриває форму для введення нових даних (наприклад, назва, опис, тип даних).<br/>
Адміністратор заповнює всі необхідні поля.<br/> Адміністратор натискає «Зберегти».<br/>
Система перевіряє правильність даних і зберігає їх у базі. |
