...
| ОСНОВНИЙ СЦЕНАРІЙ |	1. Адміністратор входить у систему.<br/> 2. Відкриває вкладку з управлінням даними.<br/> 3. Обирає дані, які потрібно редагувати.<br/> 4. Система відкриває поля для редагування вибраних даних.<br/>
5. Адміністратор вносить необхідні зміни.<br/> 6. Натискає «Зберегти зміни».<br/> 7. Система перевіряє коректність даних і зберігає їх у базі. |
